...
func initializeApplication(buildInfo handler.BuildInfo) (*Application, error) {
	...
	dailyCashbackRepository := repository.NewDailyCashbackRepository(client, db)
	...
	dailyCashbackService := service.ProvideDailyCashbackService(dailyCashbackRepository, apiKeyAuthCacheInvalidator, billingCacheService, leaderLockCache, db)
	...
	dailyCashbackHandler := admin.NewDailyCashbackHandler(dailyCashbackService)
